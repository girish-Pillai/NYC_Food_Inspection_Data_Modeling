...
DAG_ID = "dataproc_food-inspection-data-modeling"
PROJECT_ID = "food-inspection-data-modeling"
CLUSTER_NAME =  "nyc-food-inspection-dwh-airflow-cluster"
REGION = "us-east1"
STORAGE_BUCKET = "food-inspection-data-modeling"
...
DIMENSION_JOB_FILE_URI = f"gs://{STORAGE_BUCKET}/Code/NYC_Food_Dimensions.py"
FACT_FOOD_INSPECTION_JOB_FILE_URI = f"gs://{STORAGE_BUCKET}/Code/NYC_FACT_Food_Inspection.py"
FACT_FOOD_INSPECTION_VIOLATION_JOB_FILE_URI = f"gs://{STORAGE_BUCKET}/Code/NYC_FACT_Food_Inspection_violation.py"
